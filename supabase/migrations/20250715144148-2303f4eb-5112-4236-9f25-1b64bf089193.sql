-- Enable pgvector extension for similarity vectors
...
CREATE INDEX idx_songs_similarity_vector ON public.songs USING ivfflat (similarity_vector vector_cosine_ops);
